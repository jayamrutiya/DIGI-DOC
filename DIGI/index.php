		...
		<div class="container">
          ...
          <a href="" class="nav-link dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Login</a>
              ...
              <div class="row" align="center">
                <div class="col-md"><button class="btn btn-info mb-2" data-toggle="modal" data-target="#supervisorlogin">&nbsp&nbspSupervisor&nbsp&nbsp</button></div>
                <div class="col-md"><button class="btn btn-success mb-2" data-toggle="modal" data-target="#applicantlogin">&nbsp&nbsp&nbspApplicant&nbsp&nbsp&nbsp</button></div>
              </div>
            </div>
        </li> -->
			</ul>
	...
	<div class="row">
        	...
        	<div id="slider" class="carousel slide mb-5" data-ride="carousel">
	    	    ...
	    	    <div class="carousel-item active">
            		  <a href="#"><img class="d-block" src="img/DigitalIndiaLogo.png" alt="First Slide" height="550" width="1365px">
            	...
            	<div class="carousel-item">
             	 	<a href="#"><img class="d-block" src="img/T2018100255179.jpg" alt="Second Slide" height="550px" width="1365px">
            			<div class="carousel-caption d-none d-md-block">
                			<h3>Art</h3>
           		...
           		<div class="carousel-item">
              		<a href="#"><img class="d-block" src="img/T2018100255184.jpg" alt="Third Slide" height="550px" width="1365px">
              			<div class="carousel-caption d-none d-md-block">
                			<h3>Sofas</h3>
            	...
            	<div class="carousel-item">
              		<a href="#"><img class="d-block" src="img/T2018100255175.jpg" alt="Fourth Slide" height="550px" width="1365px">
              			<div class="carousel-caption d-none d-md-block">
                			<h3>Color</h3>
            	...
            	<div class="carousel-item">
              		<a><img class="d-block" src="img/aadhar-card-correction-form.png" alt="Fifth Slide" height="550px" width="1365px">
              			<div class="carousel-caption d-none d-md-block">
            	...
            	<div class="carousel-item">
              		<a href="#"><img class="d-block" src="img/Government-schemes-in-india-min-1.jpg" alt="Sixth Slide" height="550px" width="1365px">
              			<div class="carousel-caption d-none d-md-block">
  ...
  <section id="sub"> 
	<div class="container col-9">
		...
		<ul class="list-group">
			...
			<div class="card mb-3">
			<div class=card-header style="background-image : linear-gradient(to right, orange, white);"><a href="login.php" class="text-white"><h4>Apply for New Aadhar</h4></a></div>
				<div class="pt-3 pb-3 pl-5"  style="background-image: linear-gradient(rgb(255,255,255), rgb(150,193,21)); border-radius: 18px;">
					...
					<div class="pt-1 pl-1 d-flex row-hl"><a href="login.php" class="btn btn-success" onclick="document.getElementById('collapse1').style.display='block'">Aadhar Form</a></div>
				</div>
			</div>

			<div class="card mb-3">
			<div class=card-header style="background-image: linear-gradient(to left, rgb(255,255,255), rgba(163,6,0,0.7));"><a href="login.php" class="text-white"><h4>Apply for New Birth Certificate</h4></a></div>
				<div class="pt-3 pb-3 pl-5" style="background-image: linear-gradient(rgb(255,255,255), rgba(251,127,125,0.77)); border-radius: 18px;">
					...
					<div class="pt-1 pl-1 d-flex row-hl"><a href="login.php" class="btn btn-danger">Birth Certificate Form</a></div>
				</div>
			</div>

			<div class="card mb-3">
			<div class=card-header style="background-image: linear-gradient(to left, rgb(255,255,255), rgba(2,79,139,0.9));"><a href="login.php"  class="text-white"><h4>Apply for Marriage Certificate</h4></a></div>
				<div class="pt-3 pb-3 pl-5"  style="background-image: linear-gradient(rgb(255,255,255), rgb(224,158,222)); border-radius: 18px;">
					...
					<div class="pt-1 pl-1 d-flex row-hl"><a href="login.php" class="btn text-white" style="background-color: #C631DC">Marriage Certificate Form</a></div>
				</div>
			</div>
		</ul>
	</div>
	...
	<div style="padding-left: 20px;"><h3 class="pt-5"><u>Edit new Aadhar, Birth and marriage Certificate</u></h3></div>
		<div class="container-fluid mt-4">
		<ul class="list-group">
			
			<div class="card mb-3">
			<div class=card-header style="background-image : linear-gradient(to right, orange, white);"><a href="login.php" class="text-white"><h4>Correction to Aadhar Application</h4></a></div>
				<div class="pt-3 pb-3 pl-5" style="background-image: linear-gradient(rgb(255,255,255), rgb(150,193,21)); border-radius: 18px;">
					<div class="pt-1 pl-1 d-flex row-hl"><p class="text-success">Fill the Aadhar Correction Form</p></div>
					<div class="pt-1 pl-1 d-flex row-hl"><a href="login.php" class="btn btn-success">Aadhar Correction Form</a></div>
				</div>
			</div>

			<div class="card mb-3">
			<div class=card-header style="background-image: linear-gradient(to left, rgb(255,255,255), rgba(163,6,0,0.7));"><a href="login.php" class="text-white"><h4>Correction to application of Birth certificate</h4></a></div>
				<div class="pt-3 pb-3 pl-5" style="background-image: linear-gradient(rgb(255,255,255), rgba(251,127,125,0.77)); border-radius: 18px;">
					<div class="pt-1 pl-1 d-flex row-hl"><p class="text-danger">Fill the Birth Certificate correction Form</p></div>
					<div class="pt-1 pl-1 d-flex row-hl"><a href="login.php" class="btn btn-danger">Correction Form for birth Certificate</a></div>
				</div>
			</div>

			<div class="card mb-3">
			<div class=card-header style="background-image: linear-gradient(to left, rgb(255,255,255), rgba(2,79,139,0.9));"><a href="login.php"  class="text-white"><h4>Correction to application of Marriage Certificate</h4></a></div>
				<div class="pt-3 pb-3 pl-5" style="background-image: linear-gradient(rgb(255,255,255), rgb(224,158,222)); border-radius: 18px;">
					<div class="pt-1 pl-1 d-flex row-hl"><p style="color: #C631DC;">Fill the Marriage Certificate correction Form</p></div>
					<div class="pt-1 pl-1 d-flex row-hl"><a href="login.php" class="btn text-white" style="background-color: #C631DC">Correction Form for Marriage Certificate</a></div>
				</div>
			</div>
			</ul>
		</div>
