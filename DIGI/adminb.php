	...
	<!-- <div class="container"> -->
		<div class="row">
			<div class="col-4">
				...
				$q = "SELECT userid,mailid,mobileno FROM birthverify WHERE status='new'";
				...
				?>
							...
							<?php
 							if (isset($_POST['show'])) {
 								...
 								echo $mailid;
 								echo $mobileno;
 								$q = "SELECT userid FROM birthverify WHERE mailid='$mailid' AND mobileno='$mobileno'";
 								$res = mysqli_query($conn, $q);

 				 				while ($row = mysqli_fetch_array($res,MYSQLI_BOTH)) {
 				 						$userid = $row['userid'];
 				 							$_SESSION['user'] = $userid;
 				 							header("location:showb.php");
 							}}
 							?>
			...
			<div class="col-4">
				...
				$q = "SELECT userid,mailid,mobileno FROM birthverify WHERE status='unverify'";
 				$res = mysqli_query($conn, $q);
			...
			<div class="col-4">
				...
				$q = "SELECT userid,mailid,mobileno FROM birthverify WHERE status='verify'";
 				$res = mysqli_query($conn, $q);
