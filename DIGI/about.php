  ...
  <div id="about">
    <div class="container-fluid">
      <nav class="navbar justify-content-center">
        <h1 class="text-dark"><b><u>About Us</u></b></h1>
      </nav>
    </div>

    <div class="container">
      <div class="p-3">
        <p align="justify">Digi doc is the one step towards digital india. It is a website which provides functionality to issue Aadhar, birth certificate, marriage certificate.
  Anyone can apply for his/her aadhar, birth certificate, marriage certificae and also they can store their in digi-locker.</p>
  <p align="justify">Application for new certificates on this platfrom makes work easy for applicants as they can handle their process online from their smart devices from anywhere.</p>
  <p align="justify">The government officer is the on who checks the application and documents attached with respected application. If the application is applied correct and there is no need to correct any details by the applicant then the applicant is informed by sending  the mail to given E-mail address by him/her.</p>
  <p align="justify">And if there is any correctio to the appication, the applican will get the corection mail to his/her mail address and he/she is supposed to correct the application in order to proceed.</p>
  <p align="justify">Digi-locker stores the soft-copy of the documents of respected user i.e. Aadhar Card, PAN, Licence, Voter ID etc.</p> 
      </div>      
    </div>
  </div>
</div>
