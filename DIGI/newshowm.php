...
<form action="newshowm.php" method="post">
<div class="row">
	<div class="col">
		
		<?php
		$q = "SELECT ucomments FROM marriageverify where userid='$userid'";
		$res = mysqli_query($conn, $q);
		while ($row = mysqli_fetch_array($res,MYSQLI_BOTH)) {
	...
	<div class="col">
		...
		<?php
		$q = "SELECT comments FROM marriageverify where userid='$userid'";
		$res = mysqli_query($conn, $q);
		while ($row = mysqli_fetch_array($res,MYSQLI_BOTH)) {
