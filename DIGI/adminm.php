	...
	<!-- <div class="container"> -->
		<div class="row">
			<div class="col-4">
				...
				$q = "SELECT userid,mailid,mobileno FROM marriageverify WHERE status='new'";
				...
				?>
							...
							<?php
 							if (isset($_POST['show'])) {
 								...
 								echo $mailid;
 								echo $mobileno;
 								$q = "SELECT userid FROM marriageverify WHERE mailid='$mailid' AND mobileno='$mobileno'";
 								$res = mysqli_query($conn, $q);
			...
			<div class="col-4">
				...
				$q = "SELECT userid,mailid,mobileno FROM marriageverify WHERE status='unverify'";
 				$res = mysqli_query($conn, $q);
			...
			<div class="col-4">
				...
				$q = "SELECT userid,mailid,mobileno FROM marriageverify WHERE status='verify'";
 				$res = mysqli_query($conn, $q);
